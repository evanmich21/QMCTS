...
# ==========================
# Maze Generator and Maze Class
# ==========================
def generate_maze_grid(size):
    """Creates an open maze of given size (all cells free)."""
...
# ==========================
# Global Quantum Device and Precompiled QNode
# ==========================
GLOBAL_NUM_WIRES = 4  # Assume maximum options <= 16.
...
def quantum_random_choice(options):
    """
    Uses the precompiled quantum circuit to generate quantum randomness.
    """
    n = len(options)
    if n == 1:
        return options[0]
...
# ==========================
# MAIN COMPARISON DRIVER (Testing Multiple Maze Sizes)
# ==========================
def main():
    maze_sizes = [2, 3, 5, 7, 10, 20]
    ...
    for size in maze_sizes:
        ...
        print("\n=== Comparison Summary for Maze Size {}x{} ===".format(size, size))
