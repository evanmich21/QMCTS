...
# ==========================
# Helper Function: Compress Path (QMCTS Only)
# ==========================
def compress_path(path):
    """
    Removes immediate back-and-forth cycles from a path.
    For example, if the path contains [A, B, A, B], it returns [A, B].
    """
    if not path:
        return path
    compressed = [path[0]]
...
# ==========================
# Unified MCTS Search Function for Quantum Branch with Compression
# Stops when a solution is reached, compresses the path, and returns it.
# ==========================
...
# ==========================
# Standard MCTS Search Function for Classical Branch (No Compression)
# ==========================
...
# ==========================
# MAIN COMPARISON DRIVER (Multiple Preset Mazes)
# ==========================
def main():
    ...
    iterations = 1000  # Adjust iteration count as desired.
